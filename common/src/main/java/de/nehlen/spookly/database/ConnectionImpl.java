...
public class ConnectionImpl implements Connection {
    ...
    public ConnectionImpl(final ConfigurationWrapper configuration) {
        HikariConfig hikariConfig = new HikariConfig();
        hikariConfig.setJdbcUrl((String) configuration.getOrSetDefault("database.url", "jdbc:mysql://localhost:3306/database"));
        hikariConfig.setUsername((String) configuration.getOrSetDefault("database.username", "username"));
        hikariConfig.setPassword((String) configuration.getOrSetDefault("database.password", "password"));
